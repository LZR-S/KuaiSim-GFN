...
do
    ...
    do
        ...
        do
            for ACTOR_LR in 0.00003 # 0.0003 # 0.00001
            do
                for SEED in 11 # 11 13 17 19 23
                do
                    file_key=gfn4retention_${POLICY_CLASS}_${ENV_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_fret${FEEDBACK_INF_RETURN}_seed${SEED}
